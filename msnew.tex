...
pictured on the plot have $\left|\Delta P_{\rm obs}- \Delta P_{\rm calc}\right| \sim 2 \; \rm s$. We plotted the spectroscopic mass and temperature determinations of \citet{Bergeron2011}, and that of \citet{Koester2013}. The latter is off to the left of the plot, and only part of an error bar is visible. \label{ffit2}
}
\end{figure}
